...
Delete from UserGroups where GroupId= 1 or GroupId=2;
Delete from Groups where ID=1 or ID=2;
...
select * from Groups where Descriptions is  Null order by GroupName ASC;